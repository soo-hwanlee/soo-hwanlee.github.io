...
My projects focus on how nominal arguments are represented and licensed in syntax. In my dissertation, I investigate how case markers interact with honorific features in syntactically meaningful ways. I also examine the syntactic size of individual-denoting nominalizations (e.g., _a singer_) by drawing evidence from understudied and underrepresented Bantu and Kwa family languages. My findings so far suggest that entity nominalizations come in various verbal sizes and that they can be as big as TPs/NegPs and as small as a verbal complex head. 
