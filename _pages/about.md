...
Some of my ongoing projects focus on how nominal arguments are represented and licensed in syntax. I also examine the syntactic size of entity nominalizations (e.g., _a singer_) by drawing evidence from understudied and underrepresented Bantu and Kwa family languages. So far, my findings suggest that entity nominalizations come in various verbal sizes and that they can be as big as TPs and NegPs and as small as a complex head. 
